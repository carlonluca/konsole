...
public:
    explicit MultiTerminalDisplayManager(ViewManager* viewManager, QObject* parent = nullptr);
    ~MultiTerminalDisplayManager() override;
    ...
    MultiTerminalDisplay* createRootTerminalDisplay(TerminalDisplay* terminalDisplay
        , Session* session
        , Konsole::TabbedViewContainer *container);
     ...
     */
    QList<TerminalDisplay*> getTerminalDisplays() const;
     ...
     */
    MultiTerminalDisplay* cloneMtd(MultiTerminalDisplay* sourceMtd, TabbedViewContainer* container);
...
private:
     ...
     * displayed.
     */
    QHash<MultiTerminalDisplayTree*, TabbedViewContainer*> _treeToContainer;
