...
{
    _root = rootNode;
    _childToParent.insert(rootNode, nullptr);
...
MultiTerminalDisplay* MultiTerminalDisplayTree::traverseTreeAndYeldNodes(MultiTerminalDisplay* currentNode)
{
    ...
    MultiTerminalDisplay* yeld = nullptr;
...
MultiTerminalDisplay* MultiTerminalDisplayManager::removeTerminalDisplay(MultiTerminalDisplay* mtd)
{
    ...
    if (sibling) {
        ...
        if (!newParent) {
            ...
            TabbedViewContainer* container = _treeToContainer[tree];
...
QList<TerminalDisplay*> MultiTerminalDisplayManager::getTerminalDisplays() const
{
    // Get all the leaves of all the trees and return every TerminalDisplay
    QList<TerminalDisplay*> l;
    ...
    , MultiTerminalDisplay* treeRoot)
{
    ...
    TerminalDisplay* moveToTerminalDisplay = nullptr;
...
MultiTerminalDisplay* MultiTerminalDisplayManager::cloneMtd(MultiTerminalDisplay* sourceMtd, TabbedViewContainer *container)
{
    ...
    MultiTerminalDisplay* newRoot = createRootTerminalDisplay(nullptr, nullptr, container);
